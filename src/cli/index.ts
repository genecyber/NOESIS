...
function handleVoiceCommand(args: string[]): void {
  const subcommand = args[0] || 'status';
  if (subcommand === 'status') {
...
function handleIDECommand(args: string[]): void {
  const subcommand = args[0] || 'status';
  if (subcommand === 'status') {
...
function handleCodegenCommand(agent: MetamorphAgent, args: string[]): void {
  const subcommand = args[0] || 'status';
  const stance = agent.getCurrentStance();
  if (subcommand === 'status') {
...
function getFrameCodingStyle(frame: string): string {
...
function handleFederationCommand(args: string[]): void {
  const subcommand = args[0] || 'status';
  if (subcommand === 'status') {
...
function handleAuthCommand(args: string[]): void {
  const subcommand = args[0] || 'status';
  if (subcommand === 'status') {
...
function handleSyncCommand(args: string[]): void {
  const subcommand = args[0] || 'status';
  if (subcommand === 'status') {
