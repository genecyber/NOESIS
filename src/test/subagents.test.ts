...
import type { SubagentContext } from '../agent/subagents/index.js';

describe('Subagents', () => {
  const defaultContext: SubagentContext = {
  ...
  describe('Explorer Agent', () => {
    ...
    it('adapts to stance values', () => {
      const highCuriosityContext: SubagentContext = {
        stance: {
          ...createDefaultStance(),
          values: {
    ...
    it('adapts to frame', () => {
      const playfulContext: SubagentContext = {
        stance: {
          ...createDefaultStance(),
          frame: 'playful'
        },
  ...
  describe('Verifier Agent', () => {
    ...
    it('includes coherence floor from config', () => {
      const customContext: SubagentContext = {
        stance: createDefaultStance(),
        config: {
          ...createDefaultConfig(),
          coherenceFloor: 60
  ...
  describe('Reflector Agent', () => {
    ...
    it('responds to high awareness level', () => {
      const highAwarenessContext: SubagentContext = {
        stance: {
          ...createDefaultStance(),
          sentience: {
    ...
    it('includes emergent goals', () => {
      const goalsContext: SubagentContext = {
        stance: {
          ...createDefaultStance(),
          sentience: {
            ...createDefaultStance().sentience,
  ...
  describe('Dialectic Agent', () => {
    ...
    it('responds to high provocation value', () => {
      const highProvocationContext: SubagentContext = {
        stance: {
          ...createDefaultStance(),
          values: {
            ...createDefaultStance().values,
    ...
    it('responds to high synthesis value', () => {
      const highSynthesisContext: SubagentContext = {
        stance: {
          ...createDefaultStance(),
          values: {
            ...createDefaultStance().values,
