...
program
    ...
    const disallowedTools = options.disallow
        ? options.disallow.split(',').map((t) => t.trim()).filter(Boolean)
        : [];
...
function handleDocsCommand(args) {
    const subcommand = args[0] || 'status';
    if (subcommand === 'status') {
...
function handleExperimentCommand(_agent, args) {
    const subcommand = args[0] || 'status';
    if (subcommand === 'status') {
...
function handleRewriteCommand(agent, args) {
    const subcommand = args[0] || 'status';
    const stance = agent.getCurrentStance();
    if (subcommand === 'status') {
...
function handleDiffCommand(_agent, args) {
    const subcommand = args[0] || 'status';
    if (subcommand === 'status') {
...
function handleTrainingCommand(args) {
    const subcommand = args[0] || 'status';
    if (subcommand === 'status') {
...
function handleMarketplaceCommand(args) {
    const subcommand = args[0] || 'status';
    if (subcommand === 'status') {
...
function handleBenchmarkCommand(args) {
    const subcommand = args[0] || 'status';
    if (subcommand === 'status') {
...
function handleEmotionCommand(args) {
    const subcommand = args[0] || 'status';
    if (subcommand === 'status') {
...
function handleAutonomyCommand(args) {
    const subcommand = args[0] || 'status';
    if (subcommand === 'status') {
