...
function createOperator(name, description, stanceDelta = {}) {
    return {
        name: name,
        description,
...
describe('Automatic Memory Extraction', () => {
    ...
    describe('Identity Memory Creation', () => {
        ...
        it('creates identity memory on frame shift', () => {
            ...
            const operators = [
                createOperator('Reframe', 'Shift to existential perspective', { frame: 'existential' })
            ];
            const result = hooks.postTurn({
...
//# sourceMappingURL=memory-extraction.test.js.map