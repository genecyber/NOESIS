...
export class StanceAwareCodeGenerator {
     ...
     */
    getAppliedTraits(style, valueInfluence) {
        const traits = [];
     ...
     */
    generateCodeTemplate(request, style) {
     ...
     */
    generateFunction(requirements, lang, style) {
     ...
     * Generate class code
     */
    generateClass(requirements, lang, style) {
     ...
     * Generate test code
     */
    generateTest(requirements, lang, style) {
     ...
     */
    generateDocumentation(requirements, lang, _style) {
        return `# ${requirements}\n\n## Overview\n\nGenerated documentation for ${lang} code.\n\n## Usage\n\n\`\`\`${lang}\n// Example usage\n\`\`\`\n\n## API Reference\n\n- \`process()\`: Main processing function\n`;
    }
    /**
     * Generate generic code
     */
    generateGenericCode(requirements, lang, _style) {
        return `// Generated ${lang} code\n// Requirements: ${requirements}\n\n// Implementation goes here`;
    }
    /**
     * Generate code suggestions
     */
    generateSuggestions(request, style, valueInfluence) {
        const suggestions = [];
    ...
    async review(request) {
        ...
        const stanceStyledFeedback = this.generateStyledFeedback(request.code, suggestions, reviewStyle);
     ...
     */
    analyzeCode(code, _language, focusAreas) {
        const suggestions = [];
     ...
     */
    generateStyledFeedback(_code, suggestions, reviewStyle) {
        const phrase = reviewStyle.examplePhrases[Math.floor(Math.random() * reviewStyle.examplePhrases.length)];
...
//# sourceMappingURL=stance-aware.js.map