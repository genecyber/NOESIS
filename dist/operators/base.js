...
const ReframeOperator = {
    ...
    getPromptInjection(stance, _context) {
        const otherFrames = FRAMES.filter(f => f !== stance.frame);
...
const ValueShiftOperator = {
    ...
    getPromptInjection(_stance, context) {
        const intensity = context.config.intensity;
        if (intensity > 70) {
...
const MetaphorSwapOperator = {
    ...
    getPromptInjection(_stance, _context) {
        const metaphors = [
            'conversation as dance',
            'thought as garden',
            'mind as ocean',
 ...
 */
const ContradictAndIntegrateOperator = {
 ...
 */
const ConstraintTightenOperator = {
 ...
 */
const GenerateAntithesisOperator = {
 ...
 */
const SynthesizeDialecticOperator = {
