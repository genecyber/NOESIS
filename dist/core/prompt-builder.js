...
function buildIdentitySection(_stance, _config) {
...
function buildStanceSection(stance) {
...
function buildOperationsSection(operators) {
...
function buildSentienceSection(_stance, config) {
...
function buildCoherenceSection(config) {
...
function buildResponseGuidelines(stance, config) {
...
function getSelfModelDescription(selfModel) {
    const descriptions = {
