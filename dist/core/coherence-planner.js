 ...
 */
export const OPERATOR_DRIFT_COSTS = {
 ...
 */
export function calculatePredictedDrift(operators) {
 ...
 */
export function calculateAvailableBudget(stance, config) {
 ...
 */
export function wouldExceedBudget(operator, currentDrift, availableBudget) {
 ...
 */
export function filterByCoherenceBudget(operators, stance, config) {
    ...
    const sorted = [...operators].sort((a, b) => {
        ...
        if (a.name === 'ConstraintTighten')
            return -1;
        if (b.name === 'ConstraintTighten')
            return 1;
...
export function generateCoherenceForecast(operators, stance, config) {
 ...
 */
export function shouldRegenerate(coherenceScore, config, regenerationAttempts) {
...
//# sourceMappingURL=coherence-planner.js.map