 ...
 */
export declare function logMcpToolsInfo(): void;
/**
 ...
 */
export declare function createMetamorphMcpServer(): import("@anthropic-ai/claude-agent-sdk").McpSdkServerConfigWithInstance;
