...
export const webSearchTool = tool('web_search', 'Search the web for information. Returns search results with titles, URLs, and snippets. Note: This is a placeholder - in production, integrate with a search API like Firecrawl, Brave Search, or similar.', webSearchSchema, async (args) => {
    try {
...
export const webScrapeTool = tool('web_scrape', 'Extract content from a webpage. Fetches the URL and returns the text content. Note: Basic fetch implementation - for production use with JavaScript-heavy sites, integrate with Firecrawl or Puppeteer.', webScrapeSchema, async (args) => {
    try {
